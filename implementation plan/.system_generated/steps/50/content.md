Title: trec-rag-data/trec-rag-2026/development-data at main · TREC-RAG/trec-rag-data · GitHub

Description: Contribute to TREC-RAG/trec-rag-data development by creating an account on GitHub.

Source: https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data

---

[Skip to content](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data#start-of-content)

[Sign in](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2FTREC-RAG%2Ftrec-rag-data%2Ftree%2Fmain%2Ftrec-rag-2026%2Fdevelopment-data)
...
- AI CODE CREATION[GitHub CopilotWrite better code with AI](https://github.com/features/copilot)[GitHub Copilot appDirect agents from issue to merge](https://github.com/features/ai/github-app)[MCP RegistryIntegrate external tools](https://github.com/mcp)
- [GitHub CopilotWrite better code with AI](https://github.com/features/copilot)
- [GitHub Copilot appDirect agents from issue to merge](https://github.com/features/ai/github-app)
- [MCP RegistryIntegrate external tools](https://github.com/mcp)
- DEVELOPER WORKFLOWS[ActionsAutomate any workflow](https://github.com/features/actions)[CodespacesInstant dev environments](https://github.com/features/codespaces)[IssuesPlan and track work](https://github.com/features/issues)[Code ReviewManage code changes](https://github.com/features/code-review)[Code QualityEnforce quality at merge](https://github.com/features/code-quality)
...
- COMMUNITY[GitHub SponsorsFund open source developers](https://github.com/open-source/sponsors)
- [GitHub SponsorsFund open source developers](https://github.com/open-source/sponsors)
- PROGRAMS[Security Lab](https://securitylab.github.com)[Maintainer Community](https://maintainers.github.com)[Accelerator](https://github.com/open-source/accelerator)[GitHub Stars](https://stars.github.com)[Archive Program](https://archiveprogram.github.com)
...
[Sign in](https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2FTREC-RAG%2Ftrec-rag-data%2Ftree%2Fmain%2Ftrec-rag-2026%2Fdevelopment-data)
[Sign up](https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E%2Ffiles%2Fdisambiguate&source=header-repo&source_repo=TREC-RAG%2Ftrec-rag-data)
[Reload](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data)
[Reload](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data)
[Reload](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data)

There was an error while loading. [Please reload this page](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data).
[TREC-RAG](https://github.com/TREC-RAG)
[trec-rag-data](https://github.com/TREC-RAG/trec-rag-data)
- 
            [Notifications](https://github.com/login?return_to=%2FTREC-RAG%2Ftrec-rag-data)    You must be signed in to change notification settings


- 
          [Fork
    0](https://github.com/login?return_to=%2FTREC-RAG%2Ftrec-rag-data)

- 

        [Star
          3](https://github.com/login?return_to=%2FTREC-RAG%2Ftrec-rag-data)

[Notifications](https://github.com/login?return_to=%2FTREC-RAG%2Ftrec-rag-data)
[Fork
    0](https://github.com/login?return_to=%2FTREC-RAG%2Ftrec-rag-data)
[Star
          3](https://github.com/login?return_to=%2FTREC-RAG%2Ftrec-rag-data)
- 
  [Code](https://github.com/TREC-RAG/trec-rag-data)
- 
  [Issues
          0](https://github.com/TREC-RAG/trec-rag-data/issues)
- 
  [Pull requests
          0](https://github.com/TREC-RAG/trec-rag-data/pulls)
- 
  [Actions](https://github.com/TREC-RAG/trec-rag-data/actions)
- 
  [Projects](https://github.com/TREC-RAG/trec-rag-data/projects)
- 
  [Security and quality
          0](https://github.com/TREC-RAG/trec-rag-data/security)
- 
  [Insights](https://github.com/TREC-RAG/trec-rag-data/pulse)
[Code](https://github.com/TREC-RAG/trec-rag-data)
[Issues
          0](https://github.com/TREC-RAG/trec-rag-data/issues)
[Pull requests
...
- 
    ...
    [Issues](https://github.com/TREC-RAG/trec-rag-data/issues)


- 


    [Pull requests](https://github.com/TREC-RAG/trec-rag-data/pulls)
...
- 
    ...
    [Security and quality](https://github.com/TREC-RAG/trec-rag-data/security)
...
1. [trec-rag-data](https://github.com/TREC-RAG/trec-rag-data/tree/main)
2. /[trec-rag-2026](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026)
[trec-rag-data](https://github.com/TREC-RAG/trec-rag-data/tree/main)
[trec-rag-2026](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026)

## History
[History](https://github.com/TREC-RAG/trec-rag-data/commits/main/trec-rag-2026/development-data)
...
[..](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026)
[rag25-dev-nuggets](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/rag25-dev-nuggets)
[rag25-dev-nuggets](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/rag25-dev-nuggets)
[rag25-dev-umbrela-qrels](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/rag25-dev-umbrela-qrels)
[rag25-dev-umbrela-qrels](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/rag25-dev-umbrela-qrels)
[researchrubrics-dev-rubrics](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/researchrubrics-dev-rubrics)
[researchrubrics-dev-rubrics](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/researchrubrics-dev-rubrics)
[topics](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/topics)
[topics](https://github.com/TREC-RAG/trec-rag-data/tree/main/trec-rag-2026/development-data/topics)
